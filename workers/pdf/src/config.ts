...
export const workerConfig = {
  ...
  cleanupIntervalMs: integer('PDF_CLEANUP_INTERVAL_MS', 15 * 60 * 1000, 60000, 24 * 60 * 60 * 1000),
  retentionHours: integer('PDF_ARTIFACT_RETENTION_HOURS', 24, 1, 8760),
  cleanupBatchSize: integer('PDF_CLEANUP_BATCH_SIZE', 100, 1, 1000),
