...
export default function EventInsightsError({
  error,
  reset,
}: {
  ...
  return (
    <div role="alert" className="rounded-xl border border-destructive/30 bg-destructive/5 p-6">
      <h2 className="font-semibold">Không thể tải Dashboard Insights</h2>
      <p className="mt-2 text-sm leading-6 text-muted-foreground">
        Dữ liệu tổng hợp đang tạm thời không khả dụng. Bạn có thể thử lại mà không mất bộ lọc.
      </p>
