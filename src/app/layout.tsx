...
export const metadata: Metadata = { metadataBase: new URL(getSiteUrl()), title: "Memoria", description: "Memoria — áp phích, mã QR, lời chúc và bức tường công khai cho những sự kiện đáng nhớ." }
