...
const groups = [{ title: "Sản phẩm", links: [["Cách hoạt động", "#how-it-works"], ["Giao diện Mẫu", "#template-showcase"], ["Public Wall", "#public-wall"], ["Tính năng", "#features"]] }, { title: "Giải pháp", links: [["Đám cưới", "#use-cases"], ["Sinh nhật", "#use-cases"], ["Tốt nghiệp", "#use-cases"], ["Doanh nghiệp", "#use-cases"]] }, { title: "Hỗ trợ", links: [["FAQ", "#faq"], ["Đăng nhập", "/auth/login"], ["Tạo sự kiện miễn phí", "/auth/sign-up"]] }] as const
