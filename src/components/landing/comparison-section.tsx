...
const rows = [["Thông tin thường nằm rải rác", "Một điểm vào cho khách mời", true], ["Cần tự gom lại sau sự kiện", "Lời chúc và media cùng câu chuyện", true], ["Phụ thuộc vào cách tổ chức riêng", "Trình chiếu khoảnh khắc chung", true]] as const
