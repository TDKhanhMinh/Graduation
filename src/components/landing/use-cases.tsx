...
const useCases = [[Heart, "Đám cưới", "Giữ những lời chúc thân tình quanh câu chuyện của hai bạn.", "from-memory-pink/60 to-brand-100"], [Cake, "Sinh nhật", "Biến khoảnh khắc bất ngờ thành một album nhiều tiếng cười.", "from-memory-gold/70 to-memory-peach/30"], [GraduationCap, "Tốt nghiệp", "Gom lời dặn dò, hình ảnh và tự hào của một chặng đường.", "from-brand-200 to-primary/20"], [BriefcaseBusiness, "Year End Party", "Kết nối đồng đội bằng một không gian chia sẻ chung.", "from-status-info/20 to-brand-100"], [Presentation, "Hội nghị", "Để câu hỏi, insight và khoảnh khắc sự kiện ở lại có hệ thống.", "from-status-success/25 to-brand-100"]] as const
