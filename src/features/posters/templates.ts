  ...
  layouts: {
    "4:5": {
      ...
      elements: [
        ...
        { id: "title", type: "text", frame: { x: 80, y: 650, width: 920, height: 330 }, bind: "event.title", text: "Lá»… tá»‘t nghiá»‡p", editable: true, style: { fontFamily: "Geist", fontSize: 82, fontWeight: 700, fill: "#fff9ef", align: "left", lineHeight: 1.17, letterSpacing: 0 }, constraints: { maxLines: 4, minFontSize: 48, maxFontSize: 82, autoFit: true, overflow: "clip" } },
    ...
    "9:16": {
      ...
      elements: [
        ...
        { id: "title", type: "text", frame: { x: 80, y: 880, width: 920, height: 420 }, bind: "event.title", text: "Lá»… tá»‘t nghiá»‡p", editable: true, style: { fontFamily: "Geist", fontSize: 74, fontWeight: 700, fill: "#fff9ef", align: "left", lineHeight: 1.2, letterSpacing: 0 }, constraints: { maxLines: 4, minFontSize: 44, maxFontSize: 74, autoFit: true, overflow: "clip" } },
